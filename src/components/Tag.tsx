...
export const Tag = ({ tagId, handleDeleteTag, setTagsText, text }: TagInterface) => {
    ...
    return (
        <div className="flex gap-3 mr-3">
            <Input w={300} h={40} placeholder="Tag" id={`tag${tagId}`} type="text" value={value} setValue={setValue} tagId={tagId}
            />
            <Button number={tagId} onClick={handleDeleteTag} type="button" classes="text-xl text-red-500 border-red-500" text="Delete" w={160} h={40} />
        </div>
    )
}