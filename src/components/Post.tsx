        ...
        <li className="p-2 flex items-start justify-between w-[941px] h-[150px] shadow-md border-r-4 cursor-pointer bg-white">
            ...
            <div className="flex gap-2">
                <div className="flex flex-col items-center">
                    <span>John Doe</span>
                    <span className="text-sm font-light">March 5, 2020</span>
                </div>
                <img src="../../public/avatar.png" alt="avatar" height={46} width={46} />
            </div>
        </li>
    )
}