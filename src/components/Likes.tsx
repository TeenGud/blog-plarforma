...
export const Likes = ({token, isFavorited, slug, setIsFavorited, setLikes, singlePost, favorited, favoritesCount, likes}: Likes) => {
    return (
        <button
        ...
        >
            <svg
                ...
                width="16"
                height="16"
                fill={fillFunction(singlePost, favorited, isFavorited)}
                viewBox="0 0 16 16"
