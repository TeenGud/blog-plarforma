...
export const EditArticlePage = () => {
  ...
  const [tags, setTags] = useState([
    <div className="flex gap-3 mr-3" key={numberOfTags}>
      <Input w={300} h={40} placeholder="Tag" id={`tag${1}`} type="text" />
      <Button classes="text-xl text-red-500 border-red-500" text="Delete" w={160} h={40} />
    </div>,
    <div className="flex gap-3 mr-3" key={numberOfTags}>
      <Input w={300} h={40} placeholder="Tag" id={`tag${2}`} type="text" />
      <Button classes="text-xl text-red-500 border-red-500" text="Delete" w={160} h={40} />
    </div>,
    <div className="flex gap-3 mr-3" key={numberOfTags}>
      <Input w={300} h={40} placeholder="Tag" id={`tag${3}`} type="text" />
      <Button classes="text-xl text-red-500 border-red-500" text="Delete" w={160} h={40} />
    </div>,
  ]);
